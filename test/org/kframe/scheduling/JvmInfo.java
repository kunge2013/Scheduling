...
//		Data d = new Data(new byte[1024]);
		
//		Thread t = new Thread(() -> {});
//		t.setName("xxxxxxxxxx");
//		t.setDaemon(true);
		// 打印系统信息
		WeakReference<Object> w = new WeakReference<Object>("111");
	...
	private static void printThreadInfo() {
		...
		if (threadIds != null && threadIds.length > 0) {
			...
			for (ThreadInfo threadInfo : threadInfos) {
				if (threadInfo.getThreadName().indexOf("Reference Handler") >=0) {
//					threadInfo.
				}
